...
export default class IframeUploader extends Component {
    ...
    getIframeHTML(domain) {
        ...
        return `
                ...
                <body>
                    ...
                    >
                        <input id="input" type="file" name="${this.props.name}"
    ...
    render() {
        const {
      component: Tag, disabled, className, prefixCls, children, style, } = this.props;
        const iframeStyle = {
            ...IFRAME_STYLE,
        ...
        return (
            ...
            >
                <iframe
                    ref={iframenode => this.iframe = iframenode}
                    onLoad={this.onLoad}
                    style={iframeStyle}
                />
                {children}
